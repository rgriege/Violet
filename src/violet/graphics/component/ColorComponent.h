...
namespace Violet
{
	...
	public:
		...
		ColorComponent(EntityId entityId, ComponentDeserializer & deserializer);
	...
	VIOLET_API ComponentDeserializer & operator>>(ComponentDeserializer & deserializer, ColorComponent & component);
