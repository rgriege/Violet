...
void UpdateSystem::update(float /*dt*/, AlterContext & context)
{
	for (auto const & component : *m_components)
	{
		auto const & scriptComponent = context.fetch<ScriptSystem>(component.m_entity);
		scriptComponent.m_script->run(Procedure::create("update", component.m_entity, context));
	}
}